...
type Props = { className?: string; children?: React.ReactNode; withFilmGrain?: boolean; withParticles?: boolean; };
export default function BrandHeroGradient({ className="", children, withFilmGrain=true, withParticles=true }: Props) {
  return (
    <section className={["relative overflow-hidden smh-gradient-bg smh-wave-mask min-h-[52vh] flex items-center", className].join(" ")} aria-label="Hero">
