...
export function CookieBanner({ onAccept, onDecline, onCustomize, position = 'bottom', theme = 'light' }: CookieConsentProps) {
  ...
  const preferenceKeys: OptionalPreferenceKey[] = ['analytics', 'marketing', 'functional'];
        ...
        {!showDetails ? (
          ...
          <div className="max-w-2xl mx-auto">
            ...
            {preferenceKeys.map((key) => (
              <div key={key} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg mb-3">
                <div>
